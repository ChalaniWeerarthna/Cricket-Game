...
//import static cricketgame.NewGame.scoreBoard;
...
public class Team2 {
    ...
    static Map<Integer, String[]> playersteam2  = new HashMap<Integer, String[]>();// to store players details
...
public void startGame( ){
        ...
        String[] scorehow ={"-","-","Didn't play"};
        
        for(int i=1;i<=6;i++){
            playersteam2.put(i,scorehow);
            ...
            while(balls!=0){  
                ...
                switch(random){      //find marks for one ball
                    ...
                    case 7:  
                         ...
                         playerball=playerball+1;
                         howout="Bowled";
                         System.out.println("\nOooops! PLAYER "+i +" IS OUT!!!!! How:Bowled\n");
                ...
                scorehow[2]=howout;
                playersteam2.put(i,scorehow );//put payer's data into hashmap
        ...
        System.out.println("\n---------------------TEAM 2 SUMMARY------------------------" );
        System.out.println( );
        System.out.println("Team 2's "+ "total score: "+score);
       ...
       summary[1]=wickets;
       summary[2]=balls;
       ScoreBoard.scoreBoard.put(2, summary);
